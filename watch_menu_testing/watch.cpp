...
void Data_monitoring::step_tracker() {
    ...
    /*
    myFile = SD.open("DataX.txt", FILE_WRITE);
    // if the file opened okay, write to it:
    if (myFile) {
      Serial.println("Writing to test.txt...");
      Serial.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ accX);
      myFile.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ accX);
      // close the file:
      myFile.close();
      Serial.println("done.");
    } else {
    ...
    myFile = SD.open("DataX2.txt", FILE_WRITE);
    // if the file opened okay, write to it:
    if (myFile) {
      Serial.println("Writing to test.txt...");
      //Serial.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ accX);
    ...
    /*
    myFile = SD.open("DataY.txt", FILE_WRITE);
    // if the file opened okay, write to it:
    if (myFile) {
      Serial.println("Writing to test.txt...");
      Serial.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ accY);
      myFile.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ accY);
      // close the file:
      myFile.close();
      Serial.println("done.");
    } else {
    ...
    myFile = SD.open("DataY2.txt", FILE_WRITE);
    // if the file opened okay, write to it:
    if (myFile) {
      Serial.println("Writing to test.txt...");
      //Serial.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ accX);
    ...
    /*
    myFile = SD.open("DataZ.txt", FILE_WRITE);
    // if the file opened okay, write to it:
    if (myFile) {
      Serial.println("Writing to test.txt...");
      Serial.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ accZ);
      myFile.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ accZ);
      // close the file:
      myFile.close();
      Serial.println("done.");
    } else {
    ...
    myFile = SD.open("DataZ2.txt", FILE_WRITE);
    // if the file opened okay, write to it:
    if (myFile) {
      Serial.println("Writing to test.txt...");
      //Serial.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ accX);
    ...
    /*
    myFile = SD.open("StepCount.txt", FILE_WRITE);
    // if the file opened okay, write to it:
    if (myFile) {
      Serial.println("Writing to test.txt...");
      Serial.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ stepCount);
      myFile.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ stepCount);
      // close the file:
      myFile.close();
      Serial.println("done.");
    } else {
    ...
    myFile = SD.open("StepCount2.txt", FILE_WRITE);
    // if the file opened okay, write to it:
    if (myFile) {
      Serial.println("Writing to test.txt...");
      //Serial.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ accX);
      myFile.println(stepCount);
      // close the file:
      myFile.close();
      Serial.println("done.");
    } else {
...
void Data_monitoring::heartrate_tracker() {
    ...
    if (myFile) {
      Serial.println("Writing to test.txt...");
      Serial.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ heart_rate);
      myFile.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ heart_rate);
      // close the file:
      myFile.close();
      Serial.println("done.");
    } else {
    ...
    myFile = SD.open("Heart2.txt", FILE_WRITE);
    // if the file opened okay, write to it:
    if (myFile) {
      Serial.println("Writing to test.txt...");
      //Serial.println(String(year) + String(month_d) + String(day) + String(hour) + String(minuet) + "2  "+ accX);
      myFile.println(heart_rate);
      // close the file:
      myFile.close();
      Serial.println("done.");
    } else {
